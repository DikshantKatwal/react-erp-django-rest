...
import EmployeeExperienceTable from "./component/Table";
import PermissionWrapper from "../../layout/PermissionWrapperLayout";
import EmployeeExperienceForm from "./component/Form";
...
const EmployeeExperience: React.FC = () => {
    ...
    return (
                                ...
                                <div className="title-container">
                                    ...
                                    <div className="title-item">
                                        <div className="inner-item">
                                            ...
                                            <button onClick={() => openModal(null)} className="co-btn">Add Experience</button>
                                            </PermissionWrapper>
                                        </div>
                                    </div>
                                </div>
                                <EmployeeExperienceTable  shouldRefetch={shouldRefetch} openModal={openModal}  />
                                {/* table here  */}
                            </div>
                        </div>
                    </div>
        ...
        <Modal isOpen={isModalOpen} onClose={closeModal} title="Service Type">
            <EmployeeExperienceForm experience={editingRenewal} closeModal={closeModal} refetchData={refetchData}  />
        </Modal>
        </>
    )
}
