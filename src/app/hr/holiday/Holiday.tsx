...
import HolidayTable from "./component/Table";
import HolidayForm from "./component/Form";
...
const Holiday: React.FC = () => {
    ...
    return (
                                ...
                                <div className="title-container">
                                    ...
                                    <div className="title-item">
                                        <div className="inner-item">
                                            ...
                                            <button onClick={() => openModal(null)} className="co-btn">Add Holiday</button>
                                            </PermissionWrapper>
                                        </div>
                                    </div>
                                </div>
                                <HolidayTable shouldRefetch={shouldRefetch} openModal={openModal}  />
                                {/* table here  */}
                            </div>
                        </div>
                    </div>
        ...
        <Modal isOpen={isModalOpen} onClose={closeModal} title="Service Type">
            <HolidayForm holiday={editingHoliday} closeModal={closeModal} refetchData={refetchData}  />
        </Modal>
        </>
    )
}
