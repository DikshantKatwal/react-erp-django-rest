...
import EmployeeLanguageTable from "./component/Table";
import PermissionWrapper from "../../layout/PermissionWrapperLayout";
import EmployeeLanguageForm from "./component/Form";
import Modal from "../../general/Modal";


const EmployeeLanguage: React.FC = () => {
    ...
    return (
                                ...
                                <div className="title-container">
                                    ...
                                    <div className="title-item">
                                        <div className="inner-item">
                                            ...
                                            <button onClick={() => openModal(null)} className="co-btn">Add Language</button>
                                            </PermissionWrapper>
                                        </div>
                                    </div>
                                </div>
                                <EmployeeLanguageTable  shouldRefetch={shouldRefetch} openModal={openModal}  />
                                {/* table here  */}
                            </div>
                        </div>
                    </div>
        ...
        <Modal isOpen={isModalOpen} onClose={closeModal} title="Service Type">
            <EmployeeLanguageForm language={editingRenewal} closeModal={closeModal} refetchData={refetchData}  />
        </Modal>
        </>
    )
}
