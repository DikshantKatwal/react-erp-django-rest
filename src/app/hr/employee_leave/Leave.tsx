...
import LeaveTable from "./component/Table";
import LeaveForm from "./component/Form";
...
const Leave: React.FC = () => {
    ...
    return (
                                ...
                                <div className="title-container">
                                    ...
                                    <div className="title-item">
                                        <div className="inner-item">
                                            ...
                                            <button onClick={() => openModal(null)} className="co-btn">Add Leave Type</button>
                                            </PermissionWrapper>
                                        </div>
                                    </div>
                                </div>
                                <LeaveTable shouldRefetch={shouldRefetch} openModal={openModal}  />
                                {/* table here  */}
                            </div>
                        </div>
                    </div>
        ...
        <Modal isOpen={isModalOpen} onClose={closeModal} title="Service Type">
            <LeaveForm leave={editingLeave} closeModal={closeModal} refetchData={refetchData}  />
        </Modal>
        </>
    )
}
