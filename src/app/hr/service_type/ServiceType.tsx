...
import ServiceTypeTable from "./components/Table";
import ServiceTypeForm from "./components/Form";
...
const ServiceType: React.FC = () => {
    ...
    return (
                                ...
                                <div className="title-container">
                                    ...
                                    <div className="title-item">
                                        <div className="inner-item">
                                            ...
                                            <button onClick={() => openModal(null)} className="co-btn">Add Service Types</button>
                                            </PermissionWrapper>
                                        </div>
                                    </div>
                                </div>
                                <ServiceTypeTable shouldRefetch={shouldRefetch} openModal={openModal}  />
                                {/* table here  */}
                            </div>
                        </div>
                    </div>
        ...
        <Modal isOpen={isModalOpen} onClose={closeModal} title="Service Type">
            <ServiceTypeForm service_type={editingServiceType} closeModal={closeModal} refetchData={refetchData}  />
        </Modal>
        </>
    )
}
