...
import EmployeeReferenceTable from "./component/Table";
import PermissionWrapper from "../../layout/PermissionWrapperLayout";
import EmployeeReferenceForm from "./component/Form";
import Modal from "../../general/Modal";


const EmployeeReference: React.FC = () => {
    ...
    return (
                                ...
                                <div className="title-container">
                                    ...
                                    <div className="title-item">
                                        <div className="inner-item">
                                            ...
                                            <button onClick={() => openModal(null)} className="co-btn">Add Reference</button>
                                            </PermissionWrapper>
                                        </div>
                                    </div>
                                </div>
                                <EmployeeReferenceTable  shouldRefetch={shouldRefetch} openModal={openModal}  />
                                {/* table here  */}
                            </div>
                        </div>
                    </div>
        ...
        <Modal isOpen={isModalOpen} onClose={closeModal} title="Service Type">
            <EmployeeReferenceForm reference={editingRenewal} closeModal={closeModal} refetchData={refetchData}  />
        </Modal>
        </>
    )
}
