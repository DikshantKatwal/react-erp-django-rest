...
import EmployeeLeaveTable from "./component/Table";
import EmployeeLeaveForm from "./component/Form";
...
const ApplyLeave: React.FC = () => {
    ...
    return (
                                ...
                                <div className="title-container">
                                    ...
                                    <div className="title-item">
                                        <div className="inner-item">
                                            ...
                                            <button onClick={() => openModal(null)} className="co-btn">Request Leave</button>
                                            </PermissionWrapper>
                                        </div>
                                    </div>
                                </div>
                                <EmployeeLeaveTable shouldRefetch={shouldRefetch} openModal={openModal}  />
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <Modal isOpen={isModalOpen} onClose={closeModal} title="Apply Leave">
            <EmployeeLeaveForm employee_leave={editingLeave} closeModal={closeModal} refetchData={refetchData}  />
        </Modal>
        </>
    )
}
