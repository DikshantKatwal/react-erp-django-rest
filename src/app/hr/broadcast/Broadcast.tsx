...
import BroadcastForm from "./component/Form";
...
const Broadcast: React.FC = () => {
    ...
    return (
                                ...
                                <div className="title-container">
                                    ...
                                    <div className="title-item">
                                        <div className="inner-item">
                                            ...
                                            <button onClick={() => openModal(null)} className="co-btn">Add Broadcast</button>
                                            </PermissionWrapper>
                                        </div>
                                    </div>
                                </div>
                                <BroadcastTable shouldRefetch={shouldRefetch} openModal={openModal}  />
                                {/* table here  */}
                            </div>
                        </div>
                    </div>
        ...
        <Modal isOpen={isModalOpen} onClose={closeModal} title="Broadcast">
            <BroadcastForm broadcast={editingBroadcast} closeModal={closeModal} refetchData={refetchData}  />
        </Modal>
        </>
    )
}
